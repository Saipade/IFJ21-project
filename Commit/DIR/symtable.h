...
typedef struct {
    ...
    bool ifuse;                                 // if function was used
...
// Item of stack of symbol tables
...
/**
 * @brief Searches for functions that were called but not defined (inorder traversal)
 * @param symTable global symbol table
 * @return Error code
 */
