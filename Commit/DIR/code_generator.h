...
/**
 * @brief Generates code for the start of the program (auxiliary global variables, built-in functions)
 * @return Error
 */
bool cg_start (  );
...
/**
 * @brief Generates code for label of the start of while loop
 * @param index current "while index"
 * @param functionId function we are currently in
 * @return Error
 */
...
/**
 * @brief Generates code for while loop continuation check
 * @param index current "while index"
 * @param functionId function we are currently in
 * @return Error
 */
...
/**
 * @brief Generates code for the start of jump over variable declaration in while loop
...
/**
 * @brief Generates code for label required for jump over variable declaration in while loop
 * @param parserData contains all required information
 * @return Error
 */
...
/**
 * @brief Generates code for jump to the start of while loop and label for the end of while loop
 * @param index current "while index"
 * @param functionId function we are currently in
 * @return Error
 */
...
/**
 * @brief Generates code to save expression result
 * @return Error
 */
bool cg_save_result (  );
...
/**
 * @brief Generates code for stack version of "greater than or equal to"
 * @return Error
 */
bool cg_mets (  );
...
/**
 * @brief Generates code for stack version of NEQ
 * @return Error
 */
bool cg_neqs (  );

/**
 * @brief Generates operation according to given rule
